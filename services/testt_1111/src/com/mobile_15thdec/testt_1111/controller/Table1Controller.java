...
import com.mobile_15thdec.testt_1111.service.Table1Service;
import com.mobile_15thdec.testt_1111.service.Table2Service;
import java.io.*;
 ...
 * @see com.mobile_15thdec.testt_1111.Table1
 */
@RestController(value = "Testt_1111.Table1Controller")
@RequestMapping("/testt_1111/Table1")
...
public class Table1Controller {
    ...
    @Autowired
    @Qualifier("testt_1111.Table1Service")
    private Table1Service table1Service;

    @Autowired
    @Qualifier("testt_1111.Table2Service")
    ...
    public Page<Table2> findAssociatedtable2s(Pageable pageable, @PathVariable("id") Integer id) {
        LOGGER.debug("Fetching all associated table2s");
        return table2Service.findAssociatedValues(id, "table1", "id", pageable);
    }
