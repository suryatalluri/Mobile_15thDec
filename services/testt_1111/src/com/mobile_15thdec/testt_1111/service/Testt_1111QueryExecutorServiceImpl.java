...
@Service
public class Testt_1111QueryExecutorServiceImpl implements Testt_1111QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Testt_1111QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("testt_1111WMQueryExecutor")
