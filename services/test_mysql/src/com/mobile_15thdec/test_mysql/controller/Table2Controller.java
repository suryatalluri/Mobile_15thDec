...
import com.mobile_15thdec.test_mysql.service.Table2Service;
...
import com.mobile_15thdec.test_mysql.*;
import com.mobile_15thdec.test_mysql.service.*;


/**
 * Controller object for domain model class Table2.
 * @see com.mobile_15thdec.test_mysql.Table2
 */

@RestController(value = "Test_mysql.Table2Controller")
@Api(value = "/test_mysql/Table2", description = "Exposes APIs to work with Table2 resource.")
@RequestMapping("/test_mysql/Table2")
public class Table2Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table2Controller.class);

	@Autowired
	@Qualifier("test_mysql.Table2Service")
    ...
    public Table2 getTable2(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public boolean deleteTable2(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Table2 editTable2(@PathVariable("id") String id, @RequestBody Table2 instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Table2 with id: {}" , instance.getColumn2());
        instance.setColumn2(id);
