...
import com.mobile_15thdec.test_mysql.service.Table1Service;
import java.io.*;
 ...
 * @see com.mobile_15thdec.test_mysql.Table1
 */
@RestController(value = "Test_mysql.Table1Controller")
@RequestMapping("/test_mysql/Table1")
...
public class Table1Controller {
    ...
    @Autowired
    @Qualifier("test_mysql.Table1Service")
    ...
    public Table1 getTable1(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public boolean deleteTable1(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Table1 editTable1(@PathVariable("id") String id, @RequestBody Table1 instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Table1 with id: {}", instance.getColumn2());
