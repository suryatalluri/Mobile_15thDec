...
@Service
public class Test_mysqlQueryExecutorServiceImpl implements Test_mysqlQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Test_mysqlQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("test_mysqlWMQueryExecutor")
