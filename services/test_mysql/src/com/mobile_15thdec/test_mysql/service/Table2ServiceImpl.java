 ...
 */
@Service("test_mysql.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("test_mysql.Table2Dao")
    private WMGenericDao<Table2, String> wmGenericDao;
    public void setWMGenericDao(WMGenericDao<Table2, String> wmGenericDao){
        this.wmGenericDao = wmGenericDao;
    }
     @Transactional(readOnly = true, value = "test_mysqlTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "test_mysqlTransactionManager")
    @Override
    public Table2 delete(String table2Id) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "test_mysqlTransactionManager")
    @Override
    public Table2 findById(String id) throws EntityNotFoundException {
    ...
    public Table2 update(Table2 updated) throws EntityNotFoundException {
        ...
        return this.wmGenericDao.findById((String)updated.getColumn2());
    }
