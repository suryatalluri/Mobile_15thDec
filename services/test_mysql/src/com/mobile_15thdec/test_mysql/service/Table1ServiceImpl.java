 ...
 */
@Service("test_mysql.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("test_mysql.Table1Dao")
    private WMGenericDao<Table1, String> wmGenericDao;
    public void setWMGenericDao(WMGenericDao<Table1, String> wmGenericDao){
    ...
    @Override
    public Table1 delete(String table1Id) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "test_mysqlTransactionManager")
    @Override
    public Table1 findById(String id) throws EntityNotFoundException {
