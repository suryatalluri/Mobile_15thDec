...
import com.mobile_15thdec.tttt.*;


/**
 * ServiceImpl object for domain model class Table2.
 * @see com.mobile_15thdec.tttt.Table2
 */
@Service("tttt.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    public void setWMGenericDao(WMGenericDao<Table2, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "ttttTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "ttttTransactionManager")
    @Override
